<template>
  ...
  <div class="demo">
    <el-row :gutter="20" mb-4>
      ...
      <el-button size="large" :icon="Search">Large</el-button>
    ...
    <el-row :gutter="20" mb-4>
      ...
      <el-button size="large" :icon="Search" round>Large</el-button>
  ...
  <div class="demo">
    <el-row :gutter="20">
      ...
      <el-button color="#626aef" plain disabled :dark="isDark">Disabled Plain</el-button>
    </el-row>
  </div>
</template>
